...
async def run_api():
    # Правильный запуск сервера внутри asyncio
    config = uvicorn.Config(web_app.app, host="0.0.0.0", port=8000, loop="asyncio")
...
if __name__ == "__main__":
    try:
        ...
        # asyncio.run(main())
        # site.uvicorn.run("main:app", host="0.0.0.0", port=8000, reload=True)
